...
export const CommentModal = ({ post, onClose, fetchComments, addComments }) => {
    ...
    //helper nhận 1 mảng,trả về mảng mới chỉ giữ phần tử có id duy nhất(tránh bị duplicate khi scroll comment)
    const uniqueById = (list = []) => {
        const seen = new Set(); //tạo tập nhớ để ghi nhớ các id đã gặp
        ...
        <div className="comment-modal-overlay" onClick={onClose}>
            <div className="comment-modal" onClick={(e) => e.stopPropagation()}>
                <header className="comment-modal-header">
                    <div className="comment-modal-title">Bài viết của {post.author?.name}</div>
                ...
                <div className="comment-modal-body" ref={bodyRef}>
                        ...
                        <div className="post-meta">
                            ...
                            <div>
                                <div className="post-author">
                                    {authorName}
                                    {isAdmin && <span className="badge-pill-admin"><FiShield /> ADMIN</span>}
                                </div>
                    ...
                    <div className="comment-list">
                        ...
                        {comments.map((c) => {
                            const commentTime = formatRelativeTime(c.createdAt);
                            return (
                                <div key={c.id} className="comment-item">
                                    <div className="avatar small">
                                        {renderAvatar(getAvatarData(c.author))}
                                    </div>
                    ...
                    <div className="comment-input">
                        ...
                        <div className="comment-input-body">
                            <div className="comment-input-row">
                                ...
                                />
                                {!user ?
                                    <div className="inline-error">Vui lòng đăng nhập để bình luận.</div>
                                    :
