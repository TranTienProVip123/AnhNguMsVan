...
//     // ✅ Helper: Mask chỉ từ vựng trong example
//   const maskWordInExample = (example, targetWord) => {
//     if (!example || !targetWord) return example;

//     // Tạo regex để tìm từ (case-insensitive, whole word)
//     const regex = new RegExp(`\\b(${targetWord})\\b`, 'gi');
    
//     // Replace target word với dấu *
//     return example.replace(regex, (match) => {
//       return '*'.repeat(match.length);
//     });
//   };

//   // ✅ Helper: Highlight từ vựng trong example khi revealed
