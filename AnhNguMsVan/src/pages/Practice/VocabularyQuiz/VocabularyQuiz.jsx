    ...
    questions: [
      {
        ...
        options: [
          ...
          {
            id: "B",
            text: "The act of eating a large meal.",
            isCorrect: false,
          },
          {
            id: "C",
            text: "A piece of furniture used for storage.",
            isCorrect: false,
          },
          {
            id: "D",
            text: "A strong feeling of being nervous or excited.",
            isCorrect: false,
          },
        ],
      },
      ...
      <div className="vocabulary-quiz-page">
        <div className="quiz-container">
          ...
          <div className="quiz-header">
            <h2>
              Từ Vựng: {quizData.topicName} ({quizData.level})
            </h2>
          ...
          <div className="question-card">
            ...
            <div className="word-section">
              <h3 className="question-instruction">
                Chọn định nghĩa đúng cho từ sau:
              </h3>
